...
function teleportToSumoArena()
	...
	veh:setPositionRotation(arenaData.spawnLocation[chosenLocation].x, arenaData.spawnLocation[chosenLocation].y, arenaData.spawnLocation[chosenLocation].z, 0, 0, 0, 1)
